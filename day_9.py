...
def intcode(puzzle_data, user_input):
    ...
    while True:
        ...
        if opcode == 1:
            ...
            assign_value(mode_1, input_one, puzzle_data, n + 1, relative_base, user_input)
            n += 2
        elif opcode == 4:
            if mode_1 == 0:
